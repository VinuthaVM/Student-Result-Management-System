...
if (strlen($_SESSION['alogin']) == "") {
    ...
    <head>
        ...
        <title>SRMS Admin | Create Department</title>
    ...
    <body class="top-navbar-fixed">
        <div class="main-wrapper">
            ...
            <footer class="py-5 bg-dark">
                <div class="container">
                    <p class="m-0 text-center text-white"><span class="copyright-text">&#169; <?php echo date("Y"); ?> All
                            rights reserved to the University</span></p>
                </div>
