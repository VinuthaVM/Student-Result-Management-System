...
?>
    ...
    <head>
        ...
        <title>View Department-wise Marks | SRMS Admin</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">View Student-wise Marks</h2>
                                </div>
                            </div>
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">View Student-wise Marks</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql = "SELECT tblstudents.StudentName, tblstudents.RollId, tblstudents.StudentId, tblclasses.ClassName, tblclasses.ClassNameNumeric, tblclasses.Section, SUM(tblresult.Marks) AS TotalMarks, AVG(tblresult.Marks) AS Percentage FROM tblresult JOIN tblstudents ON tblstudents.StudentId = tblresult.StudentId JOIN tblclasses ON tblclasses.id = tblresult.ClassId GROUP BY tblstudents.StudentId";
