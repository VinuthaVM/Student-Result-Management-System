                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                            <th>S.no</th>
                                                            <th>Department, Year and Section</th>
                                                            <th>Subject </th>
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT tblclasses.ClassName,tblclasses.ClassNameNumeric,tblclasses.Section,tblsubjects.SubjectName,tblsubjectcombination.id as scid,tblsubjectcombination.status from tblsubjectcombination join tblclasses on tblclasses.id=tblsubjectcombination.ClassId  join tblsubjects on tblsubjects.id=tblsubjectcombination.SubjectId";
$query = $dbh->prepare($sql);
$query->execute();
...
<?php $cnt=$cnt+1;}} ?>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white"><span class="copyright-text">&#169; <?php echo date("Y"); ?> All
            rights reserved to the University</span></p></div>
        </footer>
    </body>
</html>
<?php } ?>
