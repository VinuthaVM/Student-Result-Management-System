                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Update Student Result Info</h2>
...
<?php }} ?>                                                    
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white"><span class="copyright-text">&#169; <?php echo date("Y"); ?> All rights reserved to the University</span></p></div>
        </footer>
    </body>
</html>
<?PHP } ?>
